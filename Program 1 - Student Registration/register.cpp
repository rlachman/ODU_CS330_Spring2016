...
int main( int argc, char** argv )
{
    ...
    */
    // Open student file
    ifstream studentFile("C:\\Users\\JackHawk\\Desktop\\CS 330\\CS 330 Project 1\\students-01.txt");
    if(!studentFile)
    {
    ...
    // Open request file
    ifstream requestsFile("C:\\Users\\JackHawk\\Desktop\\CS 330\\CS 330 Project 1\\requests-01.txt");
    if(!requestsFile){
